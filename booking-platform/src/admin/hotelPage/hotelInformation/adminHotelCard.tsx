...
import { useImageContext } from "../../photosPage/context/imageContext";
import { EditHotelDialog } from "../editHotel/edithotelDialog";
    ...
    <div className="md:w-[50dvw] flex flex-col  gap-4 overflow-x-hidden mx-4">
      ...
      <div className="mx-4 flex flex-col items-start gap-2">
        ...
        <ul className="list-disc mx-4">
          {hotelQuery.data.amenities.map(
            (amenity: AmenitiesInformation, index: number) => {
              return (
                <div key={index}>
